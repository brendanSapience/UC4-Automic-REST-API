...
class FoldersGETActions {
	...
	/**
	 * @purpose Set ARA Folder for Object Name
	 * @return JsonBuilder object
	 * @version v1
	 */
	public static def setv1(TOKEN, params){
		...
		//	String STARTDATE,String ENDDATE,String CONDITIONS,ConnectionPoolItem item)
					...
					JsonBuilder res = CommonARARequests.setFolder(NAME,TYPE,FOLDER,ConnectionManager.getConnectionItemFromToken(TOKEN));
	...
	/**
	 * @purpose Get ARA Folder from Object Name
	 * @return JsonBuilder object
	 * @version v1
	 */
	public static def getv1(TOKEN, params){
		...
		//	String STARTDATE,String ENDDATE,String CONDITIONS,ConnectionPoolItem item)
					ConnectionManager.getConnectionItemFromToken(TOKEN)
					JsonBuilder res = CommonARARequests.getFolder(NAME,TYPE,ConnectionManager.getConnectionItemFromToken(TOKEN));
