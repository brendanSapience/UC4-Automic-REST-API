...
import com.automic.spec.JOBFSpecDisplay;

class JobfGETActions {
			...
			if(METHOD == "usage"){
				...
				return json
					...
					if(MiscUtils.checkParams(SupportedThings, params)){
						...
						FileTransfer specobj = (FileTransfer)object;
					
						JsonBuilder json = JOBFSpecDisplay.ShowObject(conn,specobj); 
						return json
