...
import com.automic.actions.ClientActions
...
class ClientController {
	...
	def help = {
		...
		ActionClassUtils utils = new ActionClassUtils(new ClientActions().metaClass.methods*.name.unique())
	...
	def router = {
		...
		if(ConnectionManager.runTokenChecks(TOKEN)==null){
			...
			if(Environment.current == Environment.DEVELOPMENT){
				myRes = com.automic.actions.ClientActions."${OPERATION}"(VERSION,params,conn);
			}else{
