...
class AEController {
	...
	def getObjectList = {
		def ObjectList = ["Activities","Agents","All","Auth","Calendars","Changes","Client","Conn","Docu","Engine","Forecast","Jobf","Jobp","Jobs","Misc","Notifications","Prompts","Queues","Statistics",
			"Users"] as String[]
